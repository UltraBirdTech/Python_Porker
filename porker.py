...
class JokerFiveCard(Kind, Joker):
    def __init__(self):
        super().__init__('FiveCard')
...
class JokerFourCard(Kind, Joker):
    def __init__(self):
        super().__init__('FourCard')
...
class JokerThreeCard(Kind, Joker):
    def __init__(self):
        super().__init__('ThreeCard')
...
class JokerFullHouse(FullHouse, Joker):
    def __init__(self):
        super().__init__()
